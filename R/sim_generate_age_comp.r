...
sim_generate_age_comp <- function(dat_struct=NULL,rep_struct=NULL,gen_fleet=-1,gen_year=-1,apply_error=FALSE)
{
    new_age_comp_struct <- NULL

    return(new_age_comp_struct)
}
